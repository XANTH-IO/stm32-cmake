...
foreach(FAMILY ${STM32_SUPPORTED_FAMILIES_SHORT_NAME})
    if(DEFINED STM32${FAMILY}_FIND_REMOVE_ITEM)
        if(${STM32${FAMILY}_FIND_REMOVE_ITEM} IN_LIST CMSIS_FIND_COMPONENTS)
            list(REMOVE_ITEM CMSIS_FIND_COMPONENTS ${STM32${FAMILY}_FIND_REMOVE_ITEM})
            list(APPEND CMSIS_FIND_COMPONENTS ${STM32${FAMILY}_FIND_APPENDS})
        endif()
    endif()
endforeach()
