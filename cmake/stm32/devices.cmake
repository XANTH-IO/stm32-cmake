...
function(stm32_get_devices_by_family STM_DEVICES)
    ...
    if(ARG_FAMILY)
        ...
        foreach(FAMILY ${ARG_FAMILY})
            ...
            set(DEV_${FAMILY}_LIST "")
            foreach(DEVICE ${STM_DEVICE_LIST})
                stm32_extract_info(${DEVICE} FAMILY F)
                if(${F} STREQUAL ${FAMILY})
                    list(APPEND DEV_${FAMILY}_LIST ${DEVICE})
                endif()
            endforeach()
            
            list(APPEND RESULTING_DEV_LIST ${DEV_${FAMILY}_LIST})
            if(NOT DEV_${FAMILY}_LIST)
