...
foreach(FAMILY ${STM32_SUPPORTED_FAMILIES_SHORT_NAME})
    if(DEFINED STM32${FAMILY}_HAL_REMOVE_ITEM)
        if(${STM32${FAMILY}_HAL_REMOVE_ITEM} IN_LIST HAL_FIND_COMPONENTS_FAMILIES)
            list(REMOVE_ITEM HAL_FIND_COMPONENTS_FAMILIES ${STM32${FAMILY}_HAL_REMOVE_ITEM})
            list(APPEND HAL_FIND_COMPONENTS_FAMILIES ${STM32${FAMILY}_HAL_APPENDS})
        endif()
    endif()
endforeach()
