...
It uses cmake and GCC, along with newlib (libc), STM32Cube. Supports C0 F0 F1 F2 F3 F4 F7 G0 G4 H5 H7 H7RS L0 L1 L4 L5 MP1 MP2 U0 U5 WB WB0 WBA WL device families.
...
* `STM32_CUBE_<FAMILY>_PATH` - path to STM32Cube directory, where `<FAMILY>` is one
   of `C0 F0 F1 F2 F3 F4 F7 G0 G4 H5 H7 H7RS L0 L1 L4 L5 MP1 MP2 U0 U5 WB WB0 WBA WL` **default**: `/opt/STM32Cube<FAMILY>`
